  ...
  return(
    <>
        ...
        <Grid xs={12} sx={{justifyContent:"center",display:"grid"}}>
           <ExpandMore sx={{color:ColorFleche,width:{xs:"73px"},height:{xs:"54px"}}}/>
        </Grid>
        <Grid xs={12} sx={{display:"grid",justifyContent:"center",alignContent:"flex-start"}}>
          <ExpandMore sx={{color:ColorFleche,width:{xs:"73px"},height:{xs:"54px"},marginTop:"-63px"}}/>
        </Grid>
    </Grid>
    </>
  )
...
function ExpandLessCode(){
  return(
    <>
       <Grid container sx={{width:"50px"}}>
        <Grid xs={12} sx={{justifyContent:"center",display:"grid"}}>
           <ExpandLess  sx={{color:ColorFleche,width:{xs:"73px"},height:{xs:"54px"}}}/>
        </Grid>
        <Grid xs={12} sx={{display:"grid",justifyContent:"center",alignContent:"flex-start"}}>
          <ExpandLess sx={{color:ColorFleche,width:{xs:"73px"},height:{xs:"54px"},marginTop:"-63px"}}/>
        </Grid>
    </Grid>
    </>
  )
            ...
            <Grid container justifyContent={"center"} >
              <Grid item xs={2.15} sx={{marginRight:"4px"}}>
                <Grid container>
                  <Grid xs={12}  sx={{display:"grid",justifyContent:"center"}}>
                    <ComponentLogo  sx={{width:{xs:"17vw",sm:"9.77vw"},height:{xs:"17vw",sm:"9.77vw"},display:"grid",justifyContent:"center",alignContent:"center"}}>
                      <Box component="img"  src={Stand} sx={{width:{xs:"10vw",sm:"40px",md:"65px"},height:"auto"}} alt=""/>
                    </ComponentLogo> 
                  </Grid>
                  <Grid xs={12} sx={{display:"grid",justifyContent:"center"}}>
                    <ExpandMoreCode/>
              ...
              <Grid item xs={2.15} sx={{marginRight:"4px"}}>
                <Grid container>
                  ...
                  <Grid xs={12}  sx={{display:"grid",justifyContent:"center"}}>
                    <ComponentLogo sx={{width:{xs:"17vw",sm:"9.77vw"},height:{xs:"17vw",sm:"9.77vw"},display:"grid",justifyContent:"center",alignContent:"center"}}>
                        <Box component="img"  src={GroupsPersonal} sx={{width:{xs:"10vw",sm:"40px",md:"65px"},height:"auto"}} alt=""/>
                    </ComponentLogo> 
                  </Grid>
                </Grid>
              </Grid>
              <Grid item xs={2.15} sx={{marginRight:"4px"}} >
                <Grid container>
                  <Grid xs={12}  sx={{display:"grid",justifyContent:"center"}}>
                    <ComponentLogo sx={{width:{xs:"17vw",sm:"9.77vw"},height:{xs:"17vw",sm:"9.77vw"},display:"grid",justifyContent:"center",alignContent:"center"}}>
                      <Box component="img"  src={Book} sx={{width:{xs:"10vw",sm:"40px",md:"65px"},height:"auto"}} alt=""/>
                    </ComponentLogo> 
                  </Grid>
                  <Grid xs={12} sx={{display:"grid",justifyContent:"center"}}>
                    <ExpandMoreCode/>
              ...
              <Grid item xs={2.15} sx={{marginRight:"4px"}} >
                  <Grid container>
                    ...
                    <Grid xs={12}  sx={{display:"grid",justifyContent:"center"}}>
                      <ComponentLogo sx={{width:{xs:"17vw",sm:"9.77vw"},height:{xs:"17vw",sm:"9.77vw"},display:"grid",justifyContent:"center",alignContent:"center"}}>
                          <Box component="img"  src={ConferenceImage} sx={{width:{xs:"10vw",sm:"40px",md:"65px"},height:"auto"}} alt=""/>
                      </ComponentLogo> 
                    </Grid>
                  </Grid>
              </Grid>
              <Grid item xs={2.15} sx={{marginRight:"4px"}}>
                <Grid container>
                  <Grid xs={12}  sx={{display:"grid",justifyContent:"center"}}>
                    <ComponentLogo sx={{width:{xs:"17vw",sm:"9.77vw"},height:{xs:"17vw",sm:"9.77vw"},display:"grid",justifyContent:"center",alignContent:"center"}}>
                      <Box component="img"  src={Location} sx={{width:{xs:"10vw",sm:"40px",md:"65px"},height:"auto"}} alt=""/>
                    </ComponentLogo> 
                  </Grid>
                  <Grid xs={12} sx={{display:"grid",justifyContent:"center"}}>
                    <ExpandMoreCode/>
