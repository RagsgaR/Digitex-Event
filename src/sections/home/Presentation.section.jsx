...
export function Presentation(){
  ...
  <Box sx={{marginTop:"36px",zIndex:"99",position:"relative"}}>
    ...
    <Box sx={{zIndex:"99"}}>
      ...
      <Box p={2} >
          <Para2>
              A l'ère du digitale, l'innovation et l'accélération vers le numérique engagent les entreprises vers une évolution 
          ...
          <br/>
          <Para2>
            Madagascar étant un pays à opportunités pour l'externalisation des functions et des services,
          </Para2>  
          <Para2>
            Les nouvelles technologies prennent d'avantages de place dans la vie quotidienne dans le monde entier mais aussi dans notre pays,
          </Para2>
          <br/>
          <Para2>
